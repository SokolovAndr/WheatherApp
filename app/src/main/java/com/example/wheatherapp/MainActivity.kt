    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        main_btn?.setOnClickListener{
            if(user_field?.text?.toString()?.trim()?.equals("")!!)
                Toast.makeText(this, "Введите город", Toast.LENGTH_LONG).show() //всплывающее окно
            else{
                val city: String = user_field!!.text.toString()  //переменная вар на основае Строки
                val key: String = "2006d0bcbb230b8b52621cc363deccc1"  //2006d0bcbb230b8b52621cc363deccc1
